...
const imgs : {src:string, text:string}[] = [
  ...
  {src: "/test4.png", text:"Anything"}
]

export default ({ data }: Prop) => {
  return (
    <div className="p-6 bg-secondary">
      <div className="flex flex-wrap gap-x-8 pb-4">
      {
        imgs.map((el, ind) => (
          <div className="w-[250px]" key={ind}>
            <span data-state="closed">
              <div className="overflow-hidden">
                ...
                <Image alt="React Rendezvous" width={250} height={330} src={el.src} className="object-cover transition-all hover:scale-105 aspect-[3/4]" style={{color: "transparent"}}/>
              </div>
            </span>
