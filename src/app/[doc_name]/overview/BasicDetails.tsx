  ...
  return (
    <div className="p-6 bg-secondary">
      <div className="flex justify-between h-full w-full">
        <div className="w-[60%]">
          {/* Heading of Product */}
          <h1 className="text-4xl font-bold my-2">{data["Product Name"]}</h1>
          ...
          <ul className="grid grid-flow-col grid-rows-3 grid-cols-5 gap-y-4 text-sm my-6">
            ...
            <li className="flex justify-between font-semibold row-span-1 col-span-2">
              Sub-Category :{" "}
              <span className="font-normal">{data.Sub_category}</span>
            </li>
            <li className="flex justify-between font-semibold row-span-1 col-span-2">
          ...
          <div>
            ...
            The Wild Stone CODE Sunscreen Gel Creme is a versatile,
            dermatologically tested product suitable for all skin types. It
            offers broad-spectrum protection with SPF 30, making it ideal for
            daily use, particularly during summer and festive seasons.
          </div>
        </div>
