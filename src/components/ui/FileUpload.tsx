...
async function getData(extracted_text: string) {
  try {
    ...
    await sleep();
    const response = `[TextBlock(text='{"Product Name": "Good Day Biscuits", "Category": "Home & Kitchen", "Sub_category": "Cookware", "Price": 30, "Rating": 4.3, "No_rating": 15000, "Discount": 10, "M_Spend": 1000, "Supply_Chain_E": 90.0, "Sales_y": 106000, "Sales_m": 8833, "Market_T": 2.5, "Seasonality_T": 5.0}\n\nCompleteness percentage: 100%', type='text')]`;
    ...
    const completePercentage = Number(
      response.substring(
        response.lastIndexOf("Completeness percentage: ") +
